...
que les fichiers synthèses contiennent dles données qui sont exactement les mêmes que les données stockées sur le portail de données de l'ASC. Chaque fichier avait un
